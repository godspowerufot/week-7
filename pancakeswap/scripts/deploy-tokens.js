...
async function main() {
  ...
  await deployERC20ForSPLMintable("gp_token", "Godspower Token", "GPT", 9, mintAuthority);

  await deployERC20ForSPLMintable("neon_token", "neon token", "neon", 9, mintAuthority);

  await deployERC20ForSPLMintable("gp_token", "Gp Token", "Gp", 6, mintAuthority);
